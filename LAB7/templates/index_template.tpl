    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <span class="span1">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <button class="btn btn-dark" type="button" onClick="window.location='logout.php'" style="margin-left: 5px"><i class="fas fa-sign-out-alt" style="margin: 2px"></i>Logout</button>
                </li>
                {else}
                <li class="nav-item">
            ...
            <div class="container my-4" style="float: left;">
                <div class="row">
                    ...
                    <div class="col-sm-2 text-right mt-2">
                        <button class="btn btn-success" onClick="window.location='blog.php'">Create Post</button>
                    </div>
                    {/if}
                </div>
                <div class="card">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="media mb-4">
                                ...
                                <div class="btn-group-vertical" role="group">
                                    <button class="btn btn-primary mb-2"><i class="far fa-thumbs-up"></i> {$post.likes} </button> {if $user_id == $post.user_id}
                                    <button class="btn btn-success" type="button" onClick="window.location='blog.php?micropost_id={$post.id}'"> Update </button> {/if}
                                </div>
                            </li>
                            {/foreach}
                        </ul>
