    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <span class="span1">
            <ul class="navbar-nav mr-auto">
                ...
                {else}
                <li class="nav-item">
                    <button class="btn btn-dark" type="button" onClick="window.location='login.php'"><i class="fas fa-user-check"
    ...
    <div class="container-sm">
        <form action="login_action.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="inputEmail1" name="email" value="{$email}" aria-describedby="emailHelp"
